...
### **창보 학식의 명물, "창보제육"**
- **배경**  
  창보제육을 좋아하는 사람이라면 점심은 무조건 창보제육을 고른다.  
  하지만 매일 식단표를 확인하는 일은 생각보다 번거롭고, 종종 식단표 확인을 까먹어 창보제육을 먹을 기회를 놓치곤 한다.

- **해결방법**  
  매일 아침, 창보 점심 메뉴에 제육이 포함되어 있다면 디스코드 알림을 통해 창보제육 소식을 전해 창보제육을 놓치지 않는다.
...
## 🖥️ 실행 결과
- **제육이 없을 때**
<img width="318" height="72" alt="스크린샷 2026-07-14 132850" src="https://github.com/user-attachments/assets/374fb67e-eb46-4fe5-8483-bb9258532c52" />

- **제육이 있을 때**
<img width="1421" height="92" alt="image" src="https://github.com/user-attachments/assets/6d18cbdb-b68e-44d4-8d7e-93e8ae73369f" />

## ⏰ 개발 기간 및 참여 인원
- **2026.03.15 ~ 2026.03.16** (2일)
- 참여 인원 : 1명
